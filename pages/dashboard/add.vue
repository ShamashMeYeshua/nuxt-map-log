...
<template>
    <div class="container max-w-md mx-auto mt-4">
        <div class="my-4">
            ...
            <p class="text-sm text-gray-500">You can log every place that you have been, or desire to go, add photos and notes to remember (or plan) your experiences.</p>
            ...
            <form @submit.prevent="onSubmit">
                ...
                <AppFormField name="lat" label="Latitude" :error="errors.lat" type="number" :disabled="loading"/>
                <AppFormField name="lng" label="Longitude" :error="errors.lng" type="number" :disabled="loading"/>
                <div class="flex justify-end gap-2">
                    <button :disabled="loading" type="button" class="btn btn-outline" @click="router.back()"><Icon name="tabler:arrow-left" size="24" />Cancel </button>
